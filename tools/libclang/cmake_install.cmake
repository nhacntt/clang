# Install script for directory: /Users/nhacnguyen/workspace/llvm/tools/clang/tools/libclang
...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "libclang" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/Users/nhacnguyen/workspace/llvm/Build/lib/libclang.dylib")
...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "libclang-headers" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include" TYPE DIRECTORY FILES "/Users/nhacnguyen/workspace/llvm/tools/clang/tools/libclang/../../include/clang-c" FILES_MATCHING REGEX "/[^/]*\\.h$" REGEX "/\\.svn$" EXCLUDE)
endif()
